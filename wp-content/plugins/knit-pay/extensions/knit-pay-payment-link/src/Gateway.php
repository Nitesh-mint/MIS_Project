...
class Gateway {
	...
	public function ajax_create_payment_link() {
		...
		if ( ! wp_verify_nonce( filter_input( INPUT_GET, 'knit_pay_nonce', FILTER_SANITIZE_STRING ), $nonce_action ) ) {
		...
		// Currency.
		$currency = Currency::get_instance( filter_input( INPUT_GET, 'currency', FILTER_SANITIZE_STRING ) );

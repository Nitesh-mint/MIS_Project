 ...
 * Description: 500+ payment gateways knitted together to integrate with major WordPress Plugins.
 *
 * Version: 8.85.13.2
...
add_filter(
	...
	function( $gateways ) {
		...
		// RazorPay.
		if ( ! ( defined( 'KNIT_PAY_RAZORPAY_CONNECT' ) || defined( 'KNIT_PAY_RAZORPAY_API' ) ) ) {
			define( 'KNIT_PAY_RAZORPAY_CONNECT', true );
		}
		if ( defined( 'KNIT_PAY_RAZORPAY_API' ) ) {
			$GLOBALS['KNIT_PAY_RAZORPAY_API']     = true;
			$GLOBALS['KNIT_PAY_RAZORPAY_CONNECT'] = false;
		} else {

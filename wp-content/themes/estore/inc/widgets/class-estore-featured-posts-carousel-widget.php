						...
						<li>
							...
							<div class="featured-content-wrapper">
								...
								<?php if ( function_exists( 'YITH_WCWL' ) ) {
									...
									$wishlist_class = YITH_WCWL()->is_product_in_wishlist( $product_id ) ? 'yith-wcwl-wishlistexistsbrowse' : 'add_to_wishlist single_add_to_wishlist'; // phpcs:disable WordPress.WP.I18n.MissingArg ?> 
